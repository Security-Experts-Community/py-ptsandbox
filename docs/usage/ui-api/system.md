You can get information about system components
...
??? quote "Response model in `ptsandbox/models/ui/system.py`"
...
??? quote "Request model in `ptsandbox/models/ui/system.py`"
...
1. :warning: If you do not pass the parameters, then all logs will be downloaded, and this is a very large amount of data.
